    ...
    pub fn step(&self, ctx: TypingCtx<'a>) -> Result<(Rule, Vec<Self>), TypeError> {
        ...
        match (*self.pat, *self.expr.ty) {
            ...
            (P::Tuple(_), T::Ref(_, T::Abstract(_) | T::AbstractNonRef(..))) => {
                Err(TypeError::TooAbstract(D::Type))
            }
                    ...
                    match underlying_place.ty {
                        T::Ref(inner_mtbl, _) => {
                            ...
                            match o.inherited_ref_on_ref {
                                ...
                                InheritedRefOnRefBehavior::Error => {
                                    return Err(TypeError::RefPatOnDoubleRef);
                                }
                            }
                        }
            ...
            (P::Ref(..), T::Abstract(..)) => Err(TypeError::TooAbstract(D::Type)),
                ...
                match self.expr.binding_mode()? {
                    ...
                    ByRef(_) => {
                        match o.ref_binding_on_inherited {
                            ...
                            RefBindingOnInheritedBehavior::Error => {
                                Err(TypeError::RefBindingOnInhRef)
                            }
                ...
                match self.expr.binding_mode()? {
                    ...
                    ByRef(_) => {
                        match o.mut_binding_on_inherited {
                            ...
                            MutBindingOnInheritedBehavior::Error => {
                                Err(TypeError::MutBindingOnInhRef)
                            }
            ...
            (P::Abstract(..), _) => Err(TypeError::TooAbstract(D::Pattern)),
        }
    }
}
